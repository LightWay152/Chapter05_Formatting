...
public class Rule01_HorizontalFormatting {
    public Rule01_HorizontalFormatting() {super();}
    public static int getSumIntegers(int number1, int number2){return number1 + number2;}
